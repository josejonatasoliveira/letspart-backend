    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cnpj', models.CharField(blank=True, help_text='Cnpj do usuário', max_length=15, null=True, verbose_name='Cnpj do usuário')),
                ('address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='endereco.Endereco')),
